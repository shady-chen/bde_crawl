...
class BootstrapDetail extends Paginator
{
    ...
    protected  function totalshow()
    {
        ...
        $totalhtml="<li class=\"disabled\" style='background:#e5e5e5;color: #1b1b1b;display: block;width: 100%;margin-bottom: 15px;'><span>共".$this->total."条记录&nbsp&nbsp第".$this->currentPage()."页/共".$this->lastPage()."页</span></li>";
        return $totalhtml;
    ...
    protected  function  gopage()
    {
        ...
        return $gotohtml="<li><form action='' method='get' ><span><input PLACEHOLDER='跳转到' type='text' name='page' style='width: 60px;border:1px solid #e5e5e5;height: 25px;'> <input type='submit' value='确定' style='height: 27px;padding: 0 8px;color: #000;' > </span></form></li>";
        // return $totalhtml;;
